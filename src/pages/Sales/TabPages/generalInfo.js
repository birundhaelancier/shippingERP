...
export default function GeneralInfo() {
    ...
    const [showList, setShowList] = useState(
        [
            { type: 'text', label: 'Sales Person Id', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Sales Person Name', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Incentive Plan', validation: ["required"], arrVal: [] },
