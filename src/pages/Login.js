  ...
  return (
    <div className='log_par_div'>
        ...
        <Grid item xs={12} md={6} sx={12} sm={12} className="lg_sec_par">
            ...
            <img src={image} style={{ width: '60px', borderRadius: '40px' }} />
            <div style={{color:"#027eba",fontWeight:"bold"}}>Shipping ERP</div>
            </div>
            ...
            <div className='inner_child'>
                   <label>User Name</label>
                    ...
                    <div className="for_drm">
                      ...
                      <label style={{color:"#0098f5",fontWeight:"500"}}>Forgot Password?</label>
                    </div>
                    <Divider/>
                    <div style={{color:"#0098f5",fontWeight:"500",textAlign:"center",width:"100%",marginTop:"15px"}}>Register Now User?</div>
        ...
        <Grid item xs={12} md={6} sx={12} sm={12} className="login2_le_pd">
            <div className='wel_div'><div className='wel_child_d'>Welcome to <span className='ship_tile'>Shipping ERP</span></div>
            <p style={{fontSize:"13px"}}>The welcome page contains instructions and any important information you would like to convey to your customers each time they log in to use the system.</p>
            </div>
          </Grid>
