...
export default function GeneralInfo() {
    ...
    const [showList, setShowList] = useState(
        [
            { type: 'text', label: 'Vehicle Id', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Vehicle Name', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Body Type', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Length', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Breadth', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Height', validation: ["required"], arrVal: [] },   
        ]
    )
