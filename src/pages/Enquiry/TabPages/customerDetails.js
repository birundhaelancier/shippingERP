...
export default function CustomerDetails({
  ...
  }, [GetCustomerList, GetCountry, GetState, GetCity]);
   useEffect(()=>{
    if (CustomerAllDetails.length > 0) {
      ...
      profileDetails["contact"].value = CustomerAllDetails[0]["customer_contact"].first_name || ""
      profileDetails["address"].value = CustomerAllDetails[0]["cus_address"].address1 || ""
      profileDetails["country"].value = CustomerAllDetails[0]["customer_contact"].country
      profileDetails["state"].value = CustomerAllDetails[0]["customer_contact"].state || ""
      profileDetails["city"].value = CustomerAllDetails[0]["customer_contact"].city || ""
    ...
    <div>
      ...
      >
        ...
        <Grid item xs={12} md={4} sx={12} sm={12}>
          <Labelbox
            show
            type={profileDetails.cus_type.value == 2 ? "select" : "text"}
