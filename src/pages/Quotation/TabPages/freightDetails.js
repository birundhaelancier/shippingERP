...
export default function ShipmentDetails({ getType }) {
    let history = useHistory()
    const [FieldModal, setFieldModal] = useState(false);
    const tabArray = [
        { value: 'Air Freight', id: 1 },
        { value: 'Origin Pick Up Charges', id: 2 },
        { value: 'AAI Charges', id: 3 },
        { value: 'Forfait EXW charges', id: 4 },
        { value: 'Data Transmission', id: 5 },
        { value: 'X-Ray & Misc. Charges', id: 6 },
        { value: 'DO Fee', id: 7 },
        { value: 'AWB Charge', id: 8 },
        { value: 'Airline Local Charges', id: 9 },
        { value: 'CC Fees', id: 10 },
        { value: 'Admin Charges', id: 11 },
        { value: 'Duty Payment if Any', id: 12 },
        { value: 'AMS/ENS Fees', id: 13 },
        { value: 'Palletization Charges', id: 14 },
        { value: 'Fumigation Charges', id: 15 },
        { value: 'Measurement Charges', id: 16 },
    ]
    const oceanArray = [
        { value: "Ocean Freight", id: 1 },
        { value: "Origin THC", id: 2 },
        { value: "BL Fees", id: 3 },
        { value: "Inland Haulage Charges", id: 4 },
        { value: "Origin Pickup Charges", id: 5 },
        { value: "War Risk Surcharges", id: 6 },
        { value: "Low Sulphur Surcharges ( LSS)", id: 7 },
        { value: "Open Examination", id: 8 },
        { value: "Loading / Unloading fees", id: 9 },
        { value: "Customs Clearing fee", id: 10 },
        { value: "Fumigation charges", id: 11 },
        { value: "COO (Chamber Attestation)", id: 12 },
        { value: "CFS Charges", id: 13 },
        { value: "DG Surcharges", id: 14 },
        { value: "Seal fee", id: 15 },
        { value: "VGM Charges", id: 16 },
        { value: "MUC charges", id: 17 },
        { value: "Liner Local Charges", id: 18 },
        { value: "ISPS", id: 19 },
        { value: "Palletisazton charges", id: 20 },
        { value: "Measurement charges", id: 21 },
                    ...
                    <>
                        ...
                        <Grid item xs={12} md={12} sx={12} sm={12} container direction='row' justifyContent='center' spacing={2}>
                            ...
                            <Grid item xs={12} md={8} sx={12} sm={12} >
                                <LabelBoxes show type="select" dropdown={getType === 'Sea Freight' ? tabArray : oceanArray}
