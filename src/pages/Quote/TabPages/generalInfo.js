...
export default function GeneralInfo() {
    ...
    const [showList, setShowList] = useState(
        [
            { type: 'text', label: 'CQ Id', validation: ["required"], arrVal: [] },          
            ...
            { type: 'text', label: 'Stuffing Type', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Expense Type', validation: ["required"], arrVal: [] },
            { type: 'number', label: 'Amount', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Unit', validation: ["required"], arrVal: [] },
            { type: 'text', label: 'Remarks', validation: ["required"], arrVal: [] },
        ]
    )
