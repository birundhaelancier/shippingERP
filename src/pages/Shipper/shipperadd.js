...
export default function AddShipper(props) {
    ...
    const tabArray = [
        { icon: <CheckCircle />, title: 'General Info', description: <GeneralInfo shipperId={params.get("user_id")} handleActivekey={(data, id)=>handleChange(data, id)} /> },
        { icon: <CheckCircle />, title: 'Address Details', description: <AddressInfo shipperId={params.get("user_id")} userId={userId} handleActivekey={(data, id)=>handleChange(data, id)} /> },
    ]
