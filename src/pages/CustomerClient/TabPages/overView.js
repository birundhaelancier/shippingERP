      ...
      <Grid item xs={12} spacing={2} direction="row" container>
        ...
        >
          ...
          >
            ...
            <div className="add_icons" onClick={() => handleActivekey("0")}>
              <Edit />
            </div>
          </Grid>
        ...
        >
          ...
          >
            ...
            <div className="add_icons" onClick={() => handleActivekey("1")}>
              <Edit />
            </div>
          </Grid>
          {ViewCustomer.length > 0 &&
            ViewCustomer[0]?.address.map((item) => {
              return (
                <>
                  {Object.keys(addressDetails).map((data) => {
                    return (
                      <Grid item xs={12} md={3} sx={12} sm={12}>
                        <label className="labeltxtView">
                          {addressDetails[data]}
                        </label>
                        <div>{item[data]}</div>
                      </Grid>
        ...
        >
          ...
          >
            ...
            <div className="add_icons" onClick={() => handleActivekey("2")}>
              <Edit />
            </div>
          </Grid>
          {Object.keys(kycDetails).map((data) => {
            return (
              <Grid item xs={12} md={3} sx={12} sm={12}>
                ...
                <div>
                  {ViewCustomer.length > 0 && arr.includes(data)
                    ? ViewCustomer[0][data]?.split("_")[
                        ViewCustomer[0][data]?.split("_").length - 1
                      ]
                    : ViewCustomer[0][data]}
                </div>
              </Grid>
        ...
        >
          ...
          >
            ...
            <div className="add_icons" onClick={() => handleActivekey("3")}>
              <Edit />
            </div>
          </Grid>
          {ViewCustomer.length > 0 &&
            ViewCustomer[0]?.contact.map((item) => {
              return (
                <>
        ...
        >
          ...
          >
            ...
            <div className="add_icons" onClick={() => handleActivekey("4")}>
              <Edit />
            </div>
          </Grid>
          {ViewCustomer.length > 0 &&
            ViewCustomer[0]?.documents.map((item, index) => {
              return (
                <Grid item xs={12} md={3} sx={12} sm={12}>
                  <label className="labeltxtView">{`Documnet${
                    index + 0
                  }`}</label>
        ...
        >
          <FooterBtn
            backBtn
            saveBtn={"Submit"}
            onSaveBtn={() => history.push("/Customer")}
          />
        </Grid>
      </Grid>
    </div>
