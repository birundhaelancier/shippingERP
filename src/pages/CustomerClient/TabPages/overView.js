        ...
        <div>
            <Grid item xs={12} spacing={2} direction="row" container>
                    ...
                    {Object.keys(kycDetails).map((data) => {
                        return (
                            <Grid item xs={12} md={3} sx={12} sm={12}>
                                ...
                                <div>{ViewCustomer.length > 0 && arr.includes(data) ? ViewCustomer[0][data]?.split("_")[ViewCustomer[0][data]?.split("_").length - 1] : ViewCustomer[0][data]}</div>
                            </Grid>
                        )
                    })}
                ...
                <Grid item xs={12} spacing={2} direction="row" justifyContent="center" container>
                    <FooterBtn backBtn saveBtn={'Submit'} onSaveBtn={() => history.push('/Customer')} />
                </Grid>
            </Grid >
        </div >
    );
